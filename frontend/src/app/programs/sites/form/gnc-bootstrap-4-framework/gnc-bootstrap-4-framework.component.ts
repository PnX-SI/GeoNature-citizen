...
import { addClasses, inArray } from 'angular6-json-schema-form';//'../../shared';
import {
  ChangeDetectorRef,
  Component,
  Input,
...
import { JsonSchemaFormService } from 'angular6-json-schema-form';//'../../json-schema-form.service';
  ...
  template: `
    <div
      ...
      <p *ngIf="layoutNode?.type === 'submit' && jsf?.formOptions?.fieldsRequired">
       ...
       <i class="fa fa-question-circle" *ngIf="options?.helpBlock" type="button" placement="right" [ngbTooltip]="options?.helpBlock"></i>
...
export class GNCBootstrap4FrameworkComponent implements OnInit, OnChanges {
