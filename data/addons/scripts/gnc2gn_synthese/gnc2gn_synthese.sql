...
BEGIN
    ...
    ON CONFLICT (unique_acquisition_framework_id)
        DO UPDATE set
                      acquisition_framework_name = new.name
...
BEGIN
    SELECT
        ...
        where
            t_projects.id_project = new.id_project;
    ...
    ON CONFLICT (unique_dataset_id)
        DO UPDATE set
                      id_acquisition_framework = the_id_acquisition_framework
...
BEGIN
    SELECT
        ...
        WHERE
            t_programs.id_program = new.id_program;
    ...
    SELECT
        ...
        where
            t_obstax.id_observation = new.id_observation;
...
--                             , digital_proof
        ...
        ,                                                            ref_nomenclatures.get_id_nomenclature(
                                                                             'METH_OBS',
                                                                             new.json_data ->> 'nomenclature_obs_meth')
        ,                                                            ref_nomenclatures.get_id_nomenclature(
                                                                             'TECHNIQUE_OBS',
        ...
        ,                                                            ref_nomenclatures.get_id_nomenclature(
                                                                             'STATUT_OBS',
                                                                             new.json_data ->> 'nomenclature_observation_status')
        ,                                                            ref_nomenclatures.get_id_nomenclature(
                                                                             'DEE_FLOU',
...
--         ,                                                        digital_proof
    ...
    ON CONFLICT (unique_id_sinp)
        DO UPDATE set
        (unique_id_sinp, id_source, entity_source_pk_value, id_dataset, id_nomenclature_geo_object_nature,
         id_nomenclature_grp_typ, id_nomenclature_obs_meth, id_nomenclature_obs_technique, id_nomenclature_bio_status,
         id_nomenclature_bio_condition, id_nomenclature_naturalness, id_nomenclature_exist_proof,
         id_nomenclature_valid_status, id_nomenclature_diffusion_level, id_nomenclature_life_stage, id_nomenclature_sex,
...
--                             , digital_proof
            , altitude_min, altitude_max, the_geom_4326, the_geom_point, the_geom_local, date_min, date_max, observers,
         id_digitiser, id_nomenclature_determination_method, comment_description, meta_create_date, meta_update_date,
         last_action)= (new.uuid_sinp, the_id_source, new.id_observation, the_id_dataset,
                        ...
                        ref_nomenclatures.get_id_nomenclature(
                                'TYP_GRP',
                                new.json_data ->> 'nomenclature_grp_typ'), ref_nomenclatures.get_id_nomenclature(
                                'METH_OBS',
                                new.json_data ->> 'nomenclature_obs_meth'), ref_nomenclatures.get_id_nomenclature(
                                'TECHNIQUE_OBS',
                                new.json_data ->> 'nomenclature_obs_technique'), ref_nomenclatures.get_id_nomenclature(
                                'STATUT_BIO',
                                new.json_data ->> 'nomenclature_bio_status'), ref_nomenclatures.get_id_nomenclature(
                                'ETA_BIO',
                                new.json_data ->> 'nomenclature_bio_condition'), ref_nomenclatures.get_id_nomenclature(
                                'NATURALITE',
                                new.json_data ->> 'nomenclature_naturalness'), ref_nomenclatures.get_id_nomenclature(
                                'PREUVE_EXIST',
                                new.json_data ->> 'nomenclature_exist_proof'), ref_nomenclatures.get_id_nomenclature(
                                'STATUT_VALID',
                                coalesce(new.json_data ->> 'nomenclature_valid_status', '0')),
                        ref_nomenclatures.get_id_nomenclature(
                                'NIV_PRECIS',
                        ...
                        ref_nomenclatures.get_id_nomenclature(
                                'STADE_VIE',
                                new.json_data ->> 'nomenclature_life_stage'), ref_nomenclatures.get_id_nomenclature(
                                'SEXE',
                                new.json_data ->> 'nomenclature_sex'), ref_nomenclatures.get_id_nomenclature(
                                'OBJ_DENBR',
                                new.json_data ->> 'nomenclature_obj_count'), ref_nomenclatures.get_id_nomenclature(
                                'TYP_DENBR',
                                new.json_data ->> 'nomenclature_type_count'), ref_nomenclatures.get_id_nomenclature(
                                'SENSIBILITE',
                                coalesce(new.json_data ->> 'nomenclature_sensivivity', '0')),
                        ref_nomenclatures.get_id_nomenclature(
                                'STATUT_OBS',
                        ...
                        ref_nomenclatures.get_id_nomenclature(
                                'STATUT_SOURCE',
                                new.json_data ->> 'nomenclature_source_status'), ref_nomenclatures.get_id_nomenclature(
                                'TYP_INF_GEO',
                                new.json_data ->> 'nomenclature_info_geo_type'), new.count, new.count, new.cd_nom,
                        the_nom_cite
--         ,                                                        digital_proof
