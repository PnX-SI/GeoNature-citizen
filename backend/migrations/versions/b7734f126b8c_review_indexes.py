...
def upgrade():
    ...
    with op.batch_alter_table('t_projects', schema='gnc_core') as batch_op:
        ...
        batch_op.create_index(batch_op.f('ix_gnc_core_t_projects_unique_id_project'), ['unique_id_project'], unique=True)

    with op.batch_alter_table('cor_obstax_media', schema='gnc_obstax') as batch_op:
        batch_op.create_index(batch_op.f('ix_gnc_obstax_cor_obstax_media_id_data_source'), ['id_data_source'], unique=False)
        batch_op.create_index(batch_op.f('ix_gnc_obstax_cor_obstax_media_id_media'), ['id_media'], unique=False)
        batch_op.create_unique_constraint(None, ['id_match'])

    with op.batch_alter_table('t_obstax', schema='gnc_obstax') as batch_op:
        batch_op.create_index(batch_op.f('ix_gnc_obstax_t_obstax_id_program'), ['id_program'], unique=False)
    ...
    with op.batch_alter_table('cor_program_typesites', schema='gnc_sites') as batch_op:
        batch_op.create_index(batch_op.f('ix_gnc_sites_cor_program_typesites_id_program'), ['id_program'], unique=False)
        batch_op.create_index(batch_op.f('ix_gnc_sites_cor_program_typesites_id_typesite'), ['id_typesite'], unique=False)
    ...
    with op.batch_alter_table('cor_sites_obstax', schema='gnc_sites') as batch_op:
        batch_op.create_index(batch_op.f('ix_gnc_sites_cor_sites_obstax_id_obstax'), ['id_obstax'], unique=False)
        batch_op.create_index(batch_op.f('ix_gnc_sites_cor_sites_obstax_id_site'), ['id_site'], unique=False)
    ...
    with op.batch_alter_table('cor_visites_media', schema='gnc_sites') as batch_op:
        batch_op.create_index(batch_op.f('ix_gnc_sites_cor_visites_media_id_data_source'), ['id_data_source'], unique=False)
        batch_op.create_index(batch_op.f('ix_gnc_sites_cor_visites_media_id_media'), ['id_media'], unique=False)
        batch_op.create_unique_constraint(None, ['id_match'])
    ...
    with op.batch_alter_table('t_sites', schema='gnc_sites') as batch_op:
        ...
        batch_op.create_index(batch_op.f('ix_gnc_sites_t_sites_id_program'), ['id_program'], unique=False)
        batch_op.create_index(batch_op.f('ix_gnc_sites_t_sites_id_type'), ['id_type'], unique=False)
        batch_op.create_index(batch_op.f('ix_gnc_sites_t_sites_uuid_sinp'), ['uuid_sinp'], unique=True)
    ...
    with op.batch_alter_table('t_visit', schema='gnc_sites') as batch_op:
        batch_op.create_index(batch_op.f('ix_gnc_sites_t_visit_id_site'), ['id_site'], unique=False)
...
def downgrade():
    ...
    with op.batch_alter_table('t_projects', schema='gnc_core') as batch_op:
        ...
        batch_op.create_unique_constraint('t_projects_unique_id_project_key', ['unique_id_project'])
