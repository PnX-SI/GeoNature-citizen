...
class SpeciesSiteObservationModel(ObserverMixinModel, TimestampMixinModel, db.Model):
    ...
    id_species_site = db.Column(
        db.Integer, db.ForeignKey(SpeciesSiteModel.id_species_site, ondelete="CASCADE")
    )
...
class MediaOnSpeciesSiteObservationModel(TimestampMixinModel, db.Model):
    ...
    id_data_source = db.Column(
        db.Integer,
        db.ForeignKey(SpeciesSiteObservationModel.id_species_site_observation, ondelete="CASCADE"),
        nullable=False,
    )
    id_media = db.Column(
        db.Integer,
